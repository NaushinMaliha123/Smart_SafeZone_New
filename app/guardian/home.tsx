    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.pendingText}>{pendingRequests} pending request{pendingRequests === 1 ? "" : "s"}</Text>
        </View>
      </View>
            ...
            <View key={student.id} style={styles.studentCardFull}>
              <View style={styles.cardTopRow}>
                ...
                <View style={styles.studentInfoFull}>
                  ...
                  <Text style={styles.studentIdFull}>{student.student_uid || student.id}</Text>
                </View>
                <View style={[
                  styles.statusBadge, 
